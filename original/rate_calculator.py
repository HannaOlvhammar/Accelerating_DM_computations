		...
		if iQ<n and E>Emin:
			for iq in range(0,len(q_vec)):
				...
				if vmin<v_esc+v_E:
					...
					"""print("R1v0 " + str(DM_R.R1v0(q,E,cvec,j_x,u.electronmass,mu,m_chi)))
					print("R1v2 " + str(DM_R.R1v2(q,E,cvec,j_x,u.electronmass,mu,m_chi)))
					print("ReR2 " + str(DM_R.ReR2(q,E,cvec,j_x,u.electronmass,mu,m_chi)))
					print("ImR2 " + str(DM_R.ImR2(q,E,cvec,j_x,u.electronmass,mu,m_chi)))
					print("R3 " + str(DM_R.R3(q,E,cvec,j_x,u.electronmass,mu,m_chi)))
					print("R4 " + str(DM_R.R4(q,E,cvec,j_x,u.electronmass,mu,m_chi)))
					print("R5 " + str(DM_R.R5(q,E,cvec,j_x,u.electronmass,mu,m_chi)))
					"""
